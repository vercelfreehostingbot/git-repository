...
export class GetIncomeVouchersDto {
  @IsOptional()
  @Type(() => Number)
  @IsInt()
  @Min(1)
  ...
  // Matches against voucherNumber, incomeSource, or description.
  @IsOptional()
  @IsString()
  ...
  // passed here, so an operator can never query someone else's vouchers.
  @IsOptional()
  @IsString()
  createdById?: string;
